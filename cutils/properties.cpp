...
**/
int8_t property_get_bool(const char *key, int8_t default_value) { return default_value; }
...
** conversion fails, the default value is returned.
**/
int64_t property_get_int64(const char *key, int64_t default_value) { return default_value; }
...
** conversion fails, the default value is returned.
**/
int32_t property_get_int32(const char *key, int32_t default_value) { return default_value; }

/* property_set: returns 0 on success, < 0 on failure
*/
int property_set(const char *key, const char *value) { return 0; }

int property_list(void (*propfn)(const char *key, const char *value, void *cookie), void *cookie) { return 0; }
