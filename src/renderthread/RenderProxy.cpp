...
CREATE_BRIDGE3(createContext, RenderThread* thread, bool translucent,
...
CREATE_BRIDGE2(initialize, CanvasContext* context, NativeWindowType surface) {
    args->context->initialize(args->surface);
    return nullptr;
}

void RenderProxy::initialize(NativeWindowType surface) {
...
CREATE_BRIDGE2(updateSurface, CanvasContext* context, NativeWindowType surface) {
    args->context->updateSurface(args->surface);
    return nullptr;
}

void RenderProxy::updateSurface(NativeWindowType surface) {
...
CREATE_BRIDGE2(pauseSurface, CanvasContext* context, NativeWindowType surface) {
    return (void*) args->context->pauseSurface(args->surface);
}

bool RenderProxy::pauseSurface(NativeWindowType surface) {
