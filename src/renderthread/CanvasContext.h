...
public:
    ...
    void initialize(NativeWindowType surface);
    void updateSurface(NativeWindowType surface);
    bool pauseSurface(NativeWindowType surface);
...
private:
    ...
    NativeWindowType mNativeSurface;
