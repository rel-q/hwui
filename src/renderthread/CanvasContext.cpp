...
CanvasContext* CanvasContext::create(RenderThread& thread,
        bool translucent, RenderNode* rootRenderNode) {
...
void CanvasContext::setSurface(NativeWindowType surface) {
    ATRACE_CALL();
...
void CanvasContext::initialize(NativeWindowType surface) {
    setSurface(surface);
}

void CanvasContext::updateSurface(NativeWindowType surface) {
    setSurface(surface);
}

bool CanvasContext::pauseSurface(NativeWindowType surface) {
