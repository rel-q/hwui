...
void EglManager::initExtensions() {
    ...
    // TODO:baiqiang no extension EGL_KHR_swap_buffers_with_damage
...
bool EglManager::swapBuffers(const Frame& frame, const SkRect& screenDirty) {
    ATRACE_NAME("EglManager::swapBuffers");
...
void EglManager::fence() {
    EGLSyncKHR fence = eglCreateSync(mEglDisplay, EGL_SYNC_FENCE_KHR, NULL);
    eglClientWaitSync(mEglDisplay, fence,
            EGL_SYNC_FLUSH_COMMANDS_BIT_KHR, EGL_FOREVER_KHR);
    eglDestroySync(mEglDisplay, fence);
}
