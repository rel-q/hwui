...
public:
    ...
    ANDROID_API void setSwapBehavior(SwapBehavior swapBehavior = SwapBehavior::kSwap_default);
    ANDROID_API bool loadSystemProperties();
    ANDROID_API void setName(const char* name);

    ANDROID_API void initialize(NativeWindowType surface);
    ANDROID_API void updateSurface(NativeWindowType surface);
    ANDROID_API bool pauseSurface(NativeWindowType surface);
